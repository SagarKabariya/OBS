              ...
              <div class="carousel-inner ">
                <div class="item active" style="height:">
                  ...
                  <?php
						include("conn.php");
						$cid=$_GET['setxt'];
$result = mysql_query("select b.book_name,b.book_sdesc,b.image,b.book_id from book b,sub_book_cat s,main_book_cat m where b.sub_cat_id=s.sub_cat_id and s.main_book_id=m.main_book_id AND b.book_name like '%$cid%' ;");
      ...
      <div class="box-heading">
            <h3><span>Sub Categories Books </span></h3>
          </div>
              ...
              <div class="carousel-inner ">
                <div class="item active" style="height:">
                  ...
                  <?php
						include("conn.php");
						$cid=$_GET['setxt'];
						$result = mysql_query("select b.book_name,b.book_sdesc,b.image,b.book_id from book b,sub_book_cat s,main_book_cat m where b.sub_cat_id=s.sub_cat_id and s.main_book_id=m.main_book_id AND s.sub_book_cat_name like '%$cid%' ;");
						while($row=mysql_fetch_array($result))
						{
							echo "<div class='span4 product-block'><div class='product-inner'><div class='image'><a href='bookinfo.php?bookid=$row[3]'><img  src='".$row[2]."'/></a><div class='group-item'><div class='wishlist'><a onclick='addToWishList('79');' title='Add to Wish List' >Add to Wish List</a> </div><div class='compare'><a onclick='addToCompare('79');' title='Add to Compare' >Add to Compare</a> </div><div class='cart'><div ><input type='button' value='Add to Cart' onclick='addToCart('79');' class='button' /></div></div></div></div><div class='name'><a href='lorem-ipsum-dolor-sit-amet-6.html'>".$row[0]."</a></div><div class='description'>".$row[1]."</div></div></div>";
						}
      ...
      <div class="box-heading">
            <h3><span>Search By Author/publisher</span></h3>
          </div>
              ...
              <div class="carousel-inner ">
                <div class="item active" style="height:">
                  ...
                  <?php
						include("conn.php");
						$cid=$_GET['setxt'];
						$result = mysql_query("select b.book_name,b.book_sdesc,b.image,b.book_id from book b,sub_book_cat s,main_book_cat m,author_master at,publisher_master pb where b.sub_cat_id=s.sub_cat_id and s.main_book_id=m.main_book_id AND b.author_id = at.author_id AND b.publisher_id = pb.publisher_id AND pb.publisher_name like '%$cid%' or at.author_name like '%$cid%' ;");
						while($row=mysql_fetch_array($result))
						{
							echo "<div class='span4 product-block'><div class='product-inner'><div class='image'><a href='bookinfo.php?bookid=$row[3]'><img  src='".$row[2]."'/></a><div class='group-item'><div class='wishlist'><a onclick='addToWishList('79');' title='Add to Wish List' >Add to Wish List</a> </div><div class='compare'><a onclick='addToCompare('79');' title='Add to Compare' >Add to Compare</a> </div><div class='cart'><div ><input type='button' value='Add to Cart' onclick='addToCart('79');' class='button' /></div></div></div></div><div class='name'><a href='lorem-ipsum-dolor-sit-amet-6.html'>".$row[0]."</a></div><div class='description'>".$row[1]."</div></div></div>";
						}
