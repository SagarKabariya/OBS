<?php
        ...
        if(isset($_REQUEST['save']))
        {
            ...
            $data=  mysql_query("select author_name from author_master");
            ...
            if($er!=1 && $f!=1)
            {
                $in=  mysql_query("insert into author_master values(0,'$_REQUEST[name]')");
    ...
    <div class="span12">
	  ...
	  <table  border="0" cellpadding="0" cellspacing="0" align="center" width="300">
                     <form action="" name="state" method="post">
                            <tr>
                             <td valign="top" align="center" colspan="2"><h3><b>Add Author</b></h3></td>
                 </tr>
                         <tr><td><br></td></tr>
                             <tr>
                                 <td align="center"><font size="2px">Author Name :</font></td>
