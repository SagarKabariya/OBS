<?php
       ...
       $get=  mysql_query("select publisher_name from publisher_master where publisher_id=$_REQUEST[id]");
       $g= mysql_fetch_array($get);
        ...
        if(isset($_REQUEST['save']))
        {
            ...
            if($er!=1)
            {
               ...
               $up=  mysql_query("update publisher_master set publisher_name='$_REQUEST[name]' where publisher_id=$_REQUEST[id]");
  ...
  <div class="row-fluid">
    <div class="span12">
	  ...
	  <table  border="0" cellpadding="0" cellspacing="0" align="center" width="300">
                    ...
                    <tr>
                             <td valign="top" align="center" colspan="2"><h3><b>Update Publisher</b></h3></td>
                 </tr>
                    <tr>
