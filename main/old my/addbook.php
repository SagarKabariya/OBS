...
<div class="container">
  <div class="row-fluid">
    <div class="span12">
      <div id="content"><div style="margin-top:200px; margin-left:310px;"><font size="+2" color="#C72121">
	  
	  <table  border="0" cellpadding="0" cellspacing="0" align="center" width="500" >
                            <form action="" name="addproduct" method="post" enctype="multipart/form-data">
                                     <tr>
                                         <td style="padding-left: 50px;" valign="top" colspan="2"><h3><b>Add Book</b></h3></td>
                 </tr>
                                    <tr><td><br></td></tr>
                                        <tr>
                                    ...
                                    <tr>
                                        <td align="center"><font size="2">Sub-Category Name:</font></td>
                                            <td><select name="sc" id="subid">
                                                <option>--Select--</option>
                                                    <?php
                                                        $sql=  mysql_query("select sub_cat_id,sub_book_cat from sub_book_cat");
                                                        while($row=  mysql_fetch_array($sql))
                                                        {
                                                     ?>
                                                <option value="<?=$row['sub_cat_id']?>"><?=$row['sub_book_cat']?></option>
                                                <?php
                                                        }
                                                ?>
                                                </select>
